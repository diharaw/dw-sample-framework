...
)
{
    ...
    m_image = vk::Image::create(backend, VK_IMAGE_TYPE_2D, BRDF_LUT_SIZE, BRDF_LUT_SIZE, 1, 1, 1, VK_FORMAT_R32G32B32A32_SFLOAT, VMA_MEMORY_USAGE_GPU_ONLY, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT, VK_SAMPLE_COUNT_1_BIT, VK_IMAGE_LAYOUT_UNDEFINED);
